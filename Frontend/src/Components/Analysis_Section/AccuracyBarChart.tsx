...
const AccuracyBarChart: React.FC<BarChartInterface> = (props) => {
  const data = {
    labels: ["Words", "Characters"], // X-axis labels
    datasets: [
      {
        label: "Accuracy Bar Chart",
        data: [props.accuracyCalculated[0], props.accuracyCalculated[1], 100], // Y-axis data
        backgroundColor: [
