...
const CorrectionBehaviourBarChart: React.FC<BarChartInterface> = (props) => {
  const data = {
    labels: ["Back-Spaces", "Corrections per min", "Words Corrected"], // X-axis labels
    datasets: [
      {
        label: "Correction Behavior Bar Chart",
        data: [
          props.correctionBehaviourCalculated[0],
          props.correctionBehaviourCalculated[1],
          props.correctionBehaviourCalculated[2],
        ], // Y-axis data
        backgroundColor: [
...
export default CorrectionBehaviourBarChart;
