...
const SkippedBarChart: React.FC<BarChartInterface> = (props) => {
  const data = {
    labels: ["Words", "Characters"], // X-axis labels
    datasets: [
      {
        label: "Skipped Entries Bar Chart",
        data: [
          props.skippedEntriesCalculted[0],
          props.skippedEntriesCalculted[1],
        ], // Y-axis data
        backgroundColor: [
...
export default SkippedBarChart;
