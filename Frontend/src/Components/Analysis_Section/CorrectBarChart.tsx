...
const CorrectBarChart: React.FC<BarChartInterface> = (props) => {
  const data = {
    labels: ["Words", "Characters", "Spaces"], // X-axis labels
    datasets: [
      {
        label: "Correct Entries Bar Chart",
        data: [
          props.correctEntriesCalculted[0],
          props.correctEntriesCalculted[1],
          props.correctEntriesCalculted[2],
        ], // Y-axis data
        backgroundColor: [
...
export default CorrectBarChart;
